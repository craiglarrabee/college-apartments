...
const ApplicationFormGroups = ({readOnly}) => {
    return (
        <>
            ...
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="roomate">
                    ...
                    <Form.Control name="roomate" type="text" placeholder="Preferred Roommate Name" maxLength={256}
                                  readOnly={readOnly}/>
                    <Form.Text>(If you have requested a private room, this will be the person you share a connected
                        bathroom with.)</Form.Text>
                </Form.Group>
            </Row>
            ...
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="roomate2">
                    ...
                    <Form.Control name="roomate2" type="text" placeholder="Preferred Apartment Mate 1" maxLength={256}
                                  readOnly={readOnly}/>
                </Form.Group>
            </Row>
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="roomate3">
                    ...
                    <Form.Control name="roomate3" type="text" placeholder="Preferred Apartment Mate 2" maxLength={256}
                                  readOnly={readOnly}/>
                </Form.Group>
            </Row>
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="roomate4">
                    ...
                    <Form.Control name="roomate4" type="text" placeholder="Preferred Apartment Mate 3" maxLength={256}
                                  readOnly={readOnly}/>
                </Form.Group>
            </Row>
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="roomate5">
                    ...
                    <Form.Control name="roomate5" type="text" placeholder="Preferred Apartment Mate 4" maxLength={256}
                                  readOnly={readOnly}/>
                </Form.Group>
            </Row>
