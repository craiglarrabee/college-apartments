        ...
        <>
            ...
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="gender" required>
                    ...
                    {errors && errors.gender &&
                        <Form.Text className={classNames("text-danger")}>{errors && errors.gender.message}</Form.Text>}
                </Form.Group>
                <Form.Group as={Col} className="mb-3" controlId="date_of_birth">
                    ...
                    {errors && errors.date_of_birth && errors && errors.date_of_birth.type === "validate" &&
                        <Form.Text className={classNames("text-danger")}>Please enter a valid birthdate.</Form.Text>}
                </Form.Group>
            ...
            <Row>
                <Form.Group as={Col} xs={6} className="mb-3" controlId="email">
                    ...
                    />
                    {errors && errors.email &&
                        <Form.Text className={classNames("text-danger")}>{errors && errors.email.message}</Form.Text>}
                </Form.Group>
                <Form.Group as={Col} xs={6} className="mb-3" controlId="email2">
                    ...
                    {errors && errors.email2 &&
                        <Form.Text className={classNames("text-danger")}>{errors && errors.email2.message}</Form.Text>}
                </Form.Group>
            </Row>
            ...
            <Row>
                <Form.Group as={Col} className="mb-3" controlId="street">
                    ...
                    {errors && errors.street &&
                        <Form.Text className={classNames("text-danger")}>{errors && errors.street.message}</Form.Text>}
                </Form.Group>
            </Row>
            <Row>
                <Form.Group as={Col} xs={6} className="mb-3" controlId="city">
                    ...
                    {errors && errors.city &&
                        <Form.Text className={classNames("text-danger")}>{errors && errors.city.message}</Form.Text>}
                </Form.Group>
                <Form.Group as={Col} className="mb-3" controlId="state">
                    ...
                    {errors && errors.state &&
                        <Form.Text className={classNames("text-danger")}>{errors && errors.state.message}</Form.Text>}
                </Form.Group>
