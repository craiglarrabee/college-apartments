    ...
    return (
        <>
            ...
            <div className={classNames("d-inline-flex")}>
                ...
                <Form.Check className={errors.maint_experience && classNames("border-danger")} {...register("maint_work", {
            ...
            <Row>
                {errors.maint_work && <Form.Text className={classNames("text-danger")}>{errors.maint_work.message}</Form.Text>}
            </Row>
            <Row>
                <Form.Group className="mb-3" controlId="maint_experience" hidden={hideExperience}>
                    ...
                    <Form.Control className={errors.maint_experience && classNames("border-danger")} {...register("maint_experience", {
                        required: {
                    ...
                    {errors.maint_experience && <Form.Text className={classNames("text-danger")}>{errors.maint_experience.message}</Form.Text>}
                </Form.Group>
            </Row>
            <div className={classNames("d-inline-flex")}>
                <div>Are you interested in cleaning apartments during semester breaks for wages?&nbsp;</div>
                <Form.Check className={errors.maint_experience && classNames("border-danger")} {...register("clean_work", {
                    required: "This is required.",
                    setValueAs: value => value !== null ? value.toString() : ""
            ...
            <Row>
                {errors.clean_work && <Form.Text className={classNames("text-danger")}>{errors.clean_work.message}</Form.Text>}
            </Row>
            <br/>
        </>
    );
