...
export const AddUserPayment = async (site, userId, leaseId, type, amount, description, paymentNumber, semester) => {
    let [rows] = await ExecuteQuery(`INSERT INTO user_payment (site, lease_id, user_id, amount, type, description, date, payment_number, semester)
                               VALUES (?, ?, ?, ?, ?, ?, NOW(), ?, ?)`,
        [
            site,
            leaseId,
