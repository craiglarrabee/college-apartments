...
export const GetUserLeases = async (leaseDefinitionId, submitted) => {
    const queryString = submitted ?
        "SELECT l.id, l.lease_id, l.user_id, l.room_options_id, DATE_FORMAT(l.lease_date, '%M %d, %Y') AS lease_date, l.signature, l.lease_discount, l.vehicle_color, l.vehicle_make_model, l.vehicle_license, l.vehicle_state, l.vehicle_owner, l.lease_address, l.lease_home_phone, l.lease_cell_phone, l.lease_email, l.lease_parent_name, l.lease_parent_phone, CONCAT(t.first_name, ' ', t.last_name) AS name, a.room_type_id FROM user_lease l JOIN tenant t on l.user_id = t.user_id JOIN application a on l.lease_id = a.lease_id WHERE l.lease_id = ? AND l.lease_date IS NOT NULL" :
        "SELECT l.id, l.lease_id, l.user_id, l.room_options_id, DATE_FORMAT(l.lease_date, '%M %d, %Y') AS lease_date, l.signature, l.lease_discount, l.vehicle_color, l.vehicle_make_model, l.vehicle_license, l.vehicle_state, l.vehicle_owner, l.lease_address, l.lease_home_phone, l.lease_cell_phone, l.lease_email, l.lease_parent_name, l.lease_parent_phone, CONCAT(t.first_name, ' ', t.last_name) AS name, a.room_type_id FROM user_lease l JOIN tenant t on l.user_id = t.user_id JOIN application a on l.lease_id = a.lease_id WHERE l.lease_id = ? AND l.lease_date IS NULL";
