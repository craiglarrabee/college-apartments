...
export const GetUserLeaseTenants = async (year, semester) => {
    let [rows] = await ExecuteQuery("SELECT t.id, t.last_name, t.first_name, t.middle_name, t.gender, DATE_FORMAT(t.date_of_birth, '%M %d, %Y') AS date_of_birth,\n" +
        ...
        "WHERE a.processed = 1 AND a.deposit_date IS NOT NULL\n" +
