...
export const GetTenant = async (id) => {
    ...
    let [rows] = await ExecuteQuery(`SELECT t.last_name, t.first_name, t.middle_name, t.gender, 
       DATE_FORMAT(t.date_of_birth, '%Y-%m-%d') as date_of_birth, t.last_4_social, t.cell_phone, t.cell_phone2, 
       t.home_phone, t.email, t.email2, t.convicted_crime, t.convicted_explain, t.charged_crime, t.charged_explain, 
       t.street, t.city, t.state, t.zip, t.parent_name, t.parent_street, t.parent_city, t.parent_state, t.parent_zip, 
       t.parent_phone, t.user_id, CONCAT(t.first_name, ' ', t.last_name) as name, 
