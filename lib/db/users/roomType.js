...
export const GetVisibleSemesterLeaseRoomTypes = async (site, semester) => {
    const query = `
    SELECT l.id lease_id, l.description, lr.room_type_id, lr.room_rent, rt.base_type_id, rt.room_desc, rt.room_type, rt.location
    FROM lease l
